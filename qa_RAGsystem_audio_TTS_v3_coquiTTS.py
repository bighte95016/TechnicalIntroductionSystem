...
def main():
    ...
    try:
        ...
        繁體中文回答（請根據技術資訊盡可能簡潔回答，小於30字），並將P-HUD皆改成全景抬頭式顯示器：
        """
        ...
        English answer (Please answer as concisely as possible based on the technical information, within 30 words.), and replace P-HUD with P-H-U-D:
        """
